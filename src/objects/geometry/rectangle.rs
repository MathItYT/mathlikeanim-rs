...
/// A @type {Rectangle} is a quadrilateral with four right angles.
#[wasm_bindgen]
pub struct Rectangle {
    /// The @type {BoundingBox} of the rectangle.
    bbox: BoundingBox,
...
#[wasm_bindgen]
impl Rectangle {
    /// Creates a new @type {Rectangle} from a @type {BoundingBox} and an optional rotation.
    #[wasm_bindgen(constructor, return_description = "A new rectangle.")]
    pub fn new(
        #[wasm_bindgen(param_description = "The @type {BoundingBox} of the rectangle.")]
        bbox: BoundingBox,
    ...
    /// Gets a @type {VectorObjectBuilder} with the rectangle's points.
    ...
    /// Returns the top left corner of the rectangle as a @type {Point2D}.
    #[wasm_bindgen(getter, return_description = "The top left corner of the rectangle.")]
    pub fn top_left(&self) -> Point2D {
        self.position()
    }
    /// Returns the top right corner of the rectangle as a @type {Point2D}.
    ...
    /// Returns the bottom left corner of the rectangle as a @type {Point2D}.
    ...
    /// Returns the bottom right corner of the rectangle as a @type {Point2D}.
    ...
    /// Returns the top of the rectangle as a @type {Point2D}.
    ...
    /// Returns the bottom of the rectangle as a @type {Point2D}.
    ...
    /// Returns the left of the rectangle as a @type {Point2D}.
    ...
    /// Returns the right of the rectangle as a @type {Point2D}.
    ...
    /// Returns the center of the rectangle as a @type {Point2D}.
...
#[wasm_bindgen]
impl Square {
    /// Creates a new @type {Square} from a center point, side length, and optional rotation.
    #[wasm_bindgen(constructor, return_description = "A square.")]
    pub fn new(
        #[wasm_bindgen(param_description = "The center point of the square as a @type {Point2D}.")]
        center: Point2D,
    ...
    #[wasm_bindgen(getter, return_description = "A @type {Rectangle} representing the square.")]
    ...
    #[wasm_bindgen(getter, return_description = "A @type {VectorObjectBuilder} representing the square.")]
    ...
    #[wasm_bindgen(getter, return_description = "The center point of the square as a @type {Point2D}.")]
    pub fn center(&self) -> Point2D {
        self.center
    }
    /// Returns the side length of the square.
    #[wasm_bindgen(getter, return_description = "The side length of the square as a @type {Point2D}.")]
