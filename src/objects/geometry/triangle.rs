...
/// A @type {Triangle} is a polygon with three edges and three vertices.
#[wasm_bindgen]
#[derive(Clone, Debug, PartialEq)]
pub struct Triangle {
    /// The first vertex of the triangle as @type {Point2D}.
    a: Point2D,
    /// The second vertex of the triangle as @type {Point2D}.
    b: Point2D,
    /// The third vertex of the triangle as @type {Point2D}.
    c: Point2D,
}

#[wasm_bindgen]
impl Triangle {
    /// Creates a new @type {Triangle} object from three points.
    #[wasm_bindgen(constructor, return_description = "A triangle with the given vertices.")]
    pub fn new(
        #[wasm_bindgen(param_description = "The first vertex of the triangle as @type {Point2D}.")]
        a: Point2D,
        #[wasm_bindgen(param_description = "The second vertex of the triangle as @type {Point2D}.")]
        b: Point2D,
        #[wasm_bindgen(param_description = "The third vertex of the triangle as @type {Point2D}.")]
        c: Point2D,
    ) -> Triangle {
        Triangle { a, b, c }
    }
    ...
    /// Creates a @type {VectorObjectBuilder} with the triangle's points.
    #[wasm_bindgen(return_description = "A @type {VectorObjectBuilder} with the triangle's points.")]
...
/// An @type {EquilateralTriangle} is a triangle in which all three sides are equal in length.
#[wasm_bindgen]
#[derive(Clone, Debug, PartialEq)]
pub struct EquilateralTriangle {
    /// The center @type {Point2D} of the equilateral triangle.
    center: Point2D,
...
impl EquilateralTriangle {
    /// Creates a new @type {EquilateralTriangle} from a center point and side length.
    #[wasm_bindgen(constructor, return_description = "An equilateral triangle.")]
    pub fn new(
        #[wasm_bindgen(param_description = "The center @type {Point2D} of the equilateral triangle.")]
        center: Point2D,
    ...
    /// Creates a @type {Triangle} from the equilateral triangle.
    ...
    /// Creates a @type {VectorObjectBuilder} from the equilateral triangle.
    ...
    /// Returns the center @type {Point2D} of the equilateral triangle.
...
/// A @type {RightTriangle} is a triangle in which one angle is a right angle.
#[wasm_bindgen]
#[derive(Clone, Debug, PartialEq)]
pub struct RightTriangle {
    /// The center @type {Point2D} of the right triangle.
    center: Point2D,
...
#[wasm_bindgen]
impl RightTriangle {
    /// Creates a new @type {RightTriangle} from a center point, base length, height, rotation, and flip.
    #[wasm_bindgen(constructor, return_description = "A right triangle.")]
    pub fn new(
        #[wasm_bindgen(param_description = "The center @type {Point2D} of the right triangle.")]
        center: Point2D,
    ...
    /// Creates a @type {Triangle} from the right triangle.
    ...
    /// Creates a @type {VectorObjectBuilder} from the right triangle.
    #[wasm_bindgen(getter, return_description = "A vector object builder with the right triangle's points.")]
    pub fn vector_object_builder(&self) -> VectorObjectBuilder {
        self.triangle().vector_object_builder()
    }

    /// Returns the center @type {Point2D} of the right triangle.
    ...
    /// Returns the perimeter of the @type {RightTriangle}.
    ...
    /// Returns the hypotenuse of the @type {RightTriangle}.
