...
use crate::{colors::{Color, GradientImageOrColor}, objects::{three_d::{three_d_object::{Camera, LightSource, ThreeDObject}, wasm_interface::WasmThreeDObject}, vector_object::VectorObject, wasm_interface::{WasmGradientImageOrColor, WasmVectorObject}}, scene_api::SceneAPI, utils::sleep, web_renderer::render_all_vectors};
...
impl Scene {
    ...
    pub fn get_3d_object_js(&self) -> WasmThreeDObject {
        return WasmThreeDObject { three_d_object: self.three_d_object.clone() };
    }
