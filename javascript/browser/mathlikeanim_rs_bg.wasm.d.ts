...
export function wasmvectorobject_applyFunction(a: number, b: number, c: number, d: number, e: number): number;
...
export function wasmvectorobject_setFillRule(a: number, b: number, c: number, d: number): number;
export function wasmvectorobject_moveTo(a: number, b: number, c: number, d: number): number;
export function wasmvectorobject_getFillRule(a: number, b: number): void;
...
export function wasmthreedobject_applyFunction(a: number, b: number, c: number): number;
...
export function sphere(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
...
export function svgscene_renderFrame(a: number): number;
...
export function svgscene_setOnRendered(a: number, b: number): void;
export function svgscene_onRendered(a: number): number;
...
export function scene_renderFrame(a: number): number;
...
export function scene_setOnRendered(a: number, b: number): void;
export function scene_onRendered(a: number): number;
...
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h240ef8876b943f52(a: number, b: number): number;
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h99ec4e73f4875643(a: number, b: number): void;
