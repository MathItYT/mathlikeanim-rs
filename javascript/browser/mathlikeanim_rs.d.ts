...
* @returns {WasmThreeDObject}
*/
  applyFunction(f: Function, recursive: boolean): WasmThreeDObject;
/**
...
* @returns {WasmVectorObject}
*/
  applyFunction(_function: Function, recursive: boolean, about_point?: Array<any>, about_edge?: Array<any>): WasmVectorObject;
/**
...
export interface InitOutput {
  ...
  readonly wasmvectorobject_applyFunction: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly wasmthreedobject_applyFunction: (a: number, b: number, c: number) => number;
  ...
  readonly wasmthreedobject_getSubobjectsRecursively: (a: number, b: number) => void;
  ...
  readonly coordsToPoint3D: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  readonly pointToCoords3D: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
  ...
  readonly svgscene_renderFrame: (a: number) => number;
  ...
  readonly svgscene_setOnRendered: (a: number, b: number) => void;
  readonly svgscene_onRendered: (a: number) => number;
  ...
  readonly scene_renderFrame: (a: number) => number;
