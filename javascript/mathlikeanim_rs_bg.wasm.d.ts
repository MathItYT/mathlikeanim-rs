...
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h12ca61d4395ba71c(a: number, b: number): number;
export function wasm_bindgen__convert__closures__invoke2__h3666646dbf75527c(a: number, b: number, c: number, d: number): number;
