...
export function areaUnderCurve(a: number, b: number, c: number, d: number, e: number): number;
...
export function getNumbersTex(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number): number;
...
export function scene_makeFrame(a: number, b: number, c: number, d: number, e: number): void;
export function scene_wait(a: number, b: number): number;
export function scene_setCallback(a: number, b: number): void;
export function scene_callCallback(a: number): void;
export function makeTimings(a: number, b: number, c: number): void;
export function animationGroup(a: number, b: number, c: number): number;
export function create(a: number, b: number): number;
export function drawStrokeThenFill(a: number, b: number): number;
export function write(a: number, b: number): number;
export function fadeIn(a: number, b: number): number;
export function fadeOut(a: number, b: number): number;
...
export function morphShape(a: number): number;
...
export function rotateAnimation(a: number): number;
export function scaleInPlace(a: number): number;
export function setFillAnimation(a: number): number;
export function setStrokeAnimation(a: number): number;
export function shiftAnimation(a: number): number;
export function shiftImagePosition(a: number): number;
export function showTemporaily(a: number, b: number): number;
export function spinningGrow(a: number): number;
...
export function alignPoints(a: number, b: number): number;
export function addNMoreSubobjects(a: number, b: number, c: number, d: number): void;
export function alignSubobjects(a: number, b: number, c: number, d: number): number;
export function alignData(a: number, b: number, c: number): number;
...
export function svgscene_makeFrame(a: number, b: number, c: number, d: number, e: number): void;
...
export function wasm_bindgen__convert__closures__invoke2__h012970711312cd18(a: number, b: number, c: number, d: number): number;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2ec1268ddadcfa17(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h4e790cd85c9f99fb(a: number, b: number, c: number, d: number): void;
