...
export function videoscene_initFFmpeg(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
...
export function genericscene_setContext(a: number, b: number): void;
...
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc17ce19547c4c8dc(a: number, b: number): number;
export function _dyn_core__ops__function__Fn__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h329b73b7d11fcd56(a: number, b: number, c: number, d: number): number;
