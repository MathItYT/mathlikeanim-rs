...
export function nodescene_initFFmpegPartialMovie(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
...
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0ed4df36a60f0a8a(a: number, b: number): number;
