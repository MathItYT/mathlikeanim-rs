...
export function videoscene_toggleSaveFrames(a: number): number;
...
export function videoscene_renderVideo(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
...
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9b273a3cf0783c51(a: number, b: number): number;
export function _dyn_core__ops__function__Fn__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9181061f825ca14b(a: number, b: number, c: number, d: number): number;
