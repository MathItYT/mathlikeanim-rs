...
export function videoscene_toggleSaveFrames(a: number): void;
export function videoscene_initFFmpegPartialMovie(a: number, b: number, c: number, d: number, e: number, f: number, g: number): void;
export function videoscene_closeFFmpegPartialMovie(a: number): number;
export function videoscene_setFileNamePrefix(a: number, b: number, c: number): void;
...
export function videoscene_saveFrame(a: number, b: number, c: number): number;
...
export function _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hba8cd0d24b2d222d(a: number, b: number): number;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc42c17bb32885b8e(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h1f585b3b90b095c4(a: number, b: number, c: number, d: number): void;
